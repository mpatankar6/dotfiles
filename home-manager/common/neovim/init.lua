...
vim.keymap.set("n", "<leader>fs", fzf_lua.lsp_document_symbols, { desc = "Find Symbols (Document)" })
vim.keymap.set("n", "<leader>fS", fzf_lua.lsp_live_workspace_symbols, { desc = "Find Symbols (Workspace)" })
...
vim.keymap.set("n", "<leader>fgh", fzf_lua.git_hunks, { desc = "Find Git Hunks" })
vim.keymap.set("n", "<leader>fgd", fzf_lua.git_diff, { desc = "Find Git Diff" })
